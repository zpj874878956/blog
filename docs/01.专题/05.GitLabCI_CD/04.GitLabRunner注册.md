---
title: GitLabRunner注册
date: 2024-03-13 10:55:19
permalink: /pages/f39eab/
categories:
  - 专题
  - GitLabCI_CD
tags:
...
参考链接：[使用GitLab CI运行GitLab Runner并执行Pipeline_容器服务 Kubernetes 版 ACK(ACK)-阿里云帮助中心](https://help.aliyun.com/document_detail/106968.html#title-xfl-dp6-kta)
...
![9ac4c01c63c3ceda.png](http://pic.zzppjj.top/LightPicture/2024/03/9ac4c01c63c3ceda.png)

获取`group`类型的runnertoken**

进入group -> Settings -> CI/CD -> Runners -> Group Runners

![2d294332ae3da624.png](http://pic.zzppjj.top/LightPicture/2024/03/2d294332ae3da624.png)

**获取`specific`类型的runnertoken**

进入具体的项目 -> Settings -> CI/CD -> Runners -> Specific Runners

![cec67eb35316bc08.png](http://pic.zzppjj.top/LightPicture/2024/03/cec67eb35316bc08.png)
...
![1e70a783c67a71f7.png](http://pic.zzppjj.top/LightPicture/2024/03/1e70a783c67a71f7.png)
