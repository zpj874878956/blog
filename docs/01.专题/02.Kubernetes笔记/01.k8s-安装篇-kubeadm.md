...
下载Calico配置文件
wget  --no-check-certificate   https://raw.githubusercontent.com/projectcalico/calico/v3.29.2/manifests/calico.yaml
```
...
#修改文件中镜像地址为可以拉取镜像的地址
image: docker.cnb.cool/zzppjj/docker-images/node:v3.29.2
```

```bash
提前拉取镜像
ctr images pull docker.cnb.cool/zzppjj/docker-images/cni:v3.29.2
ctr images tag docker.cnb.cool/zzppjj/docker-images/cni:v3.29.2 docker.io/calico/cni:v3.29.2
ctr images pull docker.cnb.cool/zzppjj/docker-images/node:v3.29.2
ctr images tag docker.cnb.cool/zzppjj/docker-images/node:v3.29.2 docker.io/calico/node:v3.29.2
ctr images pull docker.cnb.cool/zzppjj/docker-images/kube-controllers:v3.29.2
ctr images tag docker.cnb.cool/zzppjj/docker-images/kube-controllers:v3.29.2 docker.io/calico/kube-controllers:v3.29.2
部署calico网络
