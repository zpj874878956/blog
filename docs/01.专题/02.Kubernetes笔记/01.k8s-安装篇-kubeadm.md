...
```bash
nmcli con mod ens160 ipv4.addresses 192.168.171.139/24
nmcli con mod ens160 ipv4.gateway 192.168.171.2
...
192.168.171.138 k8s-node1
192.168.171.139 k8s-node2 
```
