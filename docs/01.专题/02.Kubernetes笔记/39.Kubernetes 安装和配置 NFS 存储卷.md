...
helm install csi-driver-nfs csi-driver-nfs/csi-driver-nfs \
  --namespace kube-system \
  --version v4.13.2 \
  --set image.nfs.repository=docker.cnb.cool/zzppjj/docker-images/nfsplugin \
  --set image.nfs.tag=v4.13.2 \
  --set image.csiProvisioner.repository=docker.cnb.cool/zzppjj/docker-images/csi-provisioner \
  --set image.csiProvisioner.tag=v6.1.0 \
  --set image.csiResizer.repository=docker.cnb.cool/zzppjj/docker-images/csi-resizer \
  --set image.csiResizer.tag=v2.0.0 \
  --set image.nodeDriverRegistrar.repository=docker.cnb.cool/zzppjj/docker-images/csi-node-driver-registrar \
  --set image.nodeDriverRegistrar.tag=v2.15.0 \
  --set image.livenessProbe.repository=docker.cnb.cool/zzppjj/docker-images/livenessprobe \
  --set image.livenessProbe.tag=v2.17.0 \
  --set image.csiSnapshotter.repository=docker.cnb.cool/zzppjj/docker-images/csi-snapshotter \
  --set image.csiSnapshotter.tag=v8.4.0 \
