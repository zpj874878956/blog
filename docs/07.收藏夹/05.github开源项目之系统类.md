...
109、**[go-music-dl](https://github.com/guohuiyuan/go-music-dl)**
一个基于 Go 语言的全网音乐搜索与下载工具。支持 CLI 命令行与 Web 服务双模式，内置网易云、QQ、酷狗、Bilibili、汽水音乐等 10+ 个主流平台，支持多源并发搜索与无损音质解析。

110、[LunaTV](https://github.com/MoonTechLab/LunaTV)

**MoonTV** 是一个开箱即用的、跨平台的影视聚合播放器。它基于 **Next.js 14** + **Tailwind CSS** + **TypeScript** 构建，支持多资源搜索、在线播放、收藏同步、播放记录、云端存储，让你可以随时随地畅享海量免费影视内容。

111、**[CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI)**
...
112、PearOS最新版系统，linux桌面系统，有点像苹果系统

地址：https://pearos.xyz/downloads

113、[dnet](https://github.com/cxbdasheng/dnet)

一款轻量级动态网络管理工具，支持多平台的 CDN、DNS 和 内网穿透自动化管理与监控

114、[ezbookkeeping](https://github.com/mayswind/ezbookkeeping)

一款轻量级、可自行托管的个人理财应用程序，具有用户友好的界面和强大的记账功能

115、https://github.com/ZhuLinsen/daily_stock_analysis
