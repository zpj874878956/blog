...
总体架构如下
![d4d6f2d4e3165cfa.jpg](https://chatpdf.quantchatai.top/2023/07/d4d6f2d4e3165cfa.jpg)
![f7579a7eec639de9.jpg](https://chatpdf.quantchatai.top/2023/07/f7579a7eec639de9.jpg)
SkyWalking架构总体分为四部分：
...
![](https://chatpdf.quantchatai.top/2023/07/51b2df477ca7c8f0.png)
## 与应用集成方式
...
![](https://chatpdf.quantchatai.top/2023/07/2139a112d73bd6db.png)
部署Demo应用
```bash
#下载
...
![](https://chatpdf.quantchatai.top/2023/07/2fe2ad2ec67715a8.png)
查看Skywalking的数据，点击右上角自动的按钮进行自动的刷新

调用Top耗时显示和响应耗时范围展示

![](https://chatpdf.quantchatai.top/2023/07/b19fae015e3ebc4e.png)
服务响应时间和调用成功率
![](https://chatpdf.quantchatai.top/2023/07/6d5f64dbc8823cd6.png)

全局调用链路展示
![](https://chatpdf.quantchatai.top/2023/07/a92eb27234b4ab66.png)
![](https://chatpdf.quantchatai.top/2023/07/f3eb8d189522bdb5.png)
![](https://chatpdf.quantchatai.top/2023/07/d62cf61d87da2f4f.png)
总结：  
